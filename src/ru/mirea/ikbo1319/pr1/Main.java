...
//Интерфейс Java 8 Stream представляет метод map() который принимает функцию в качестве аргумента.
// Эта функция применяется к каждому элементу в потоке и возвращает новый поток.